...
class EMfields3D                // :public Field
{
  public:
    ...
    void initAMRVAC(VirtualTopology3D * vct, Grid * grid, Collective * col);
    ...
    //kdm addition 16-05-2016 fix B from AMRVAC
    void fixBAMRVAC(Grid * grid, VirtualTopology3D * vct);
    ...
    void perfectAMRVACLeftS(double ***vectorX, double ***vectorY, double ***vectorZ, Grid * grid, int dir);
    void perfectAMRVACRightS(double ***vectorX, double ***vectorY, double ***vectorZ, Grid * grid, int dir);
    void perfectAMRVACLeft(double ***imageX, double ***imageY, double ***imageZ, double ***vectorX, double ***vectorY, double ***vectorZ, int dir, Grid * grid);
    void perfectAMRVACRight(double ***imageX, double ***imageY, double ***imageZ, double ***vectorX, double ***vectorY, double ***vectorZ, int dir, Grid * grid);
  ...
  private:
    ...
    //kdm addition 06-05-2016
    //void MHDBCE(double ***vectorX, double ***vectorY, double ***vectorZ,int nx, int ny, int nz,Grid *grid, VirtualTopology3D *vct);
